...
public class RouterTest {
    ...
    public void routesToIndexHandler() throws IOException {
        Handler routeToHandlerForGet = router.routeNewRequest(setParameters("GET", "/", "", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandlerForGet instanceof IndexHandler);

        Handler routeToHandlerForHead = router.routeNewRequest(setParameters("HEAD", "/", "", "HTTP/1.1"), dataStore);
    ...
    public void routesToFormHandler() throws IOException {
        ...
        Handler routeToHandlerForPost = router.routeNewRequest(setParameters("POST", "/form", "data=fatcat", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandlerForPost instanceof FormHandler);

        Handler routeToHandlerForPut = router.routeNewRequest(setParameters("PUT", "/form", "data=heathcliff", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandlerForPut instanceof FormHandler);
    }

    @Test
    public void routesToRedirectHandler() throws IOException {
        Handler routeToHandler = router.routeNewRequest(setParameters("GET", "/redirect", "", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandler instanceof RedirectHandler);
    }

    @Test
    public void routesToFileHandler() throws IOException {
        Handler routeToHandlerForJPEG = router.routeNewRequest(setParameters("GET", "/image.jpeg", "", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandlerForJPEG instanceof FileHandler);

        Handler routeToHandlerForPNG = router.routeNewRequest(setParameters("GET", "/image.png", "", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandlerForPNG instanceof FileHandler);

        Handler routeToHandlerForGIF = router.routeNewRequest(setParameters("GET", "/image.gif", "", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandlerForGIF instanceof FileHandler);

        Handler routeToHandlerForText = router.routeNewRequest(setParameters("GET", "/text-file.txt", "", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandlerForText instanceof FileHandler);

        Handler routeToHandlerForFile = router.routeNewRequest(setParameters("GET", "/file1", "", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandlerForFile instanceof FileHandler);
    }

    @Test
    public void routesToCoffeeHandler() throws IOException {
        Handler routeToHandlerForCoffee = router.routeNewRequest(setParameters("GET", "/coffee", "", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandlerForCoffee instanceof CoffeeHandler);

        Handler routeToHandlerForTea = router.routeNewRequest(setParameters("GET", "/tea", "", "HTTP/1.1"), dataStore);
    ...
    public void routesToMethodOptionsHandler() throws IOException {
        Handler routeToHandler = router.routeNewRequest(setParameters("OPTIONS", "/method_options", "", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandler instanceof MethodOptionsHandler);
    }

    @Test
    public void routesToMethodOptionsTwoHandler() throws IOException {
        Handler routeToHandler = router.routeNewRequest(setParameters("FKJDASFRWO", "/method_options2", "", "HTTP/1.1"), dataStore);
        assertTrue(routeToHandler instanceof MethodOptionsTwoHandler);
    }

    @Test
    public void routesToErrorHandler() throws IOException {
        Handler erroneousRouteToHandler = router.routeNewRequest(setParameters("HEAD", "/foobar", "", "HTTP/1.1"), dataStore);
